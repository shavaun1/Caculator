...
int main() {
	...
	if (conversion.find("calculator") != string::npos)
	{
		...
		default:
			...
			cout << "Enter the lenght you want to convert ex- inches,feet,yards,miles: ";
			cin >> len;
		...
		else if (conversion.find("area") != string::npos)
		{
			...
			cout << "Enter the lenght you want to convert ex- square_inches, square_feet, square_yards, square_miles,acres ";
			cin >> ar;
		...
		else if (conversion.find("temperature") != string::npos)
		{
			...
			cout << "Enter the Farhrenheit temperature you want to convert ex farh_temp: ";
			cin >> tem;
		...
		cout << "Enter the lenght you want to convert ex- teaspoon tablespoon fluid_ounces cups pints quarts gallons cubic_feet cubic_yards ";
		cin >> vol;
		...
		cout << "Enter the mass you want to convert ex- ounces pounds short_tons: ";
		cin >> ma;
